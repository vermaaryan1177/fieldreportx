        ...
        <View className="flex-1 bg-white">
            ...
            <View className="items-center py-6 bg-white/10">
                ...
                <View className="w-24 h-24 rounded-full border-2 border-primary items-center justify-center">
                    <Text className="text-3xl font-bold ">AK</Text>
                </View>
            ...
            <View className="px-5 py-4">
                ...
                <View className="flex-row justify-between items-center py-4 border-b border-black">
                    ...
                    <Text className="text-black">ABC@gmail.com</Text>
                </View>
                ...
                <View className="flex-row justify-between items-center py-4 border-b border-black">
                    ...
                    <Text className="text-black">0111 111 111</Text>
                </View>
                ...
                <View className="flex-row justify-between items-center py-4 border-b border-zinc-200">
                    <Text className="">Organisation</Text>

                    <Text className="">Field Inspectors Co</Text>
                </View>
            </View>
            ...
            <View className="px-5 pb-6">
                ...
                <View className="flex-row justify-between">
                    ...
                    <View className="bg-zinc-100 rounded-lg p-4 w-[31%] items-center border rounded-lg border-black">
                        <Text className="text-3xl font-bold">47</Text>
